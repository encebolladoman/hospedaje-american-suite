      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground">
            Cerca de los principales puntos de interes en Guayaquil
          </p>
        </div>

        <div className="grid gap-8 lg:grid-cols-2">
          {/* Map Embed */}
          <div className="relative aspect-square overflow-hidden rounded-xl border border-border/50 bg-muted shadow-sm lg:aspect-auto lg:min-h-[500px]">
            <iframe
              ...
              title={`Ubicacion de ${siteConfig.name}`}
          ...
          <div className="flex flex-col">
            ...
            <Button
              asChild
              size="lg"
              className="mt-6 bg-primary text-primary-foreground transition-all duration-200 hover:bg-primary/90 hover:shadow-md"
            >
              <a
        ...
        <div className="mt-16 rounded-2xl bg-primary/5 p-8 lg:p-12">
          <div className="mx-auto max-w-3xl text-center">
            <h3 className="mb-4 text-2xl font-bold text-foreground sm:text-3xl">
              Como llegar al Consulado desde {siteConfig.shortName}
            </h3>
            <p className="mb-6 text-muted-foreground">
              Desde {siteConfig.name} puedes caminar al Consulado de Estados Unidos en aproximadamente 8 minutos. Nuestra ubicacion es ideal para personas que tienen citas de visa o cualquier tramite consular, permitiendote llegar descansado y a tiempo a tu entrevista.
            </p>
            <Button
              asChild
              size="lg"
              className="bg-primary text-primary-foreground transition-all duration-200 hover:bg-primary/90 hover:shadow-md"
            >
              <a
                href={siteConfig.mapUrl}
                target="_blank"
